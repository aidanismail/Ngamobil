...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO penyewa (nama_depan, nama_belakang, alamat, nomor_telepon, email, password) VALUES (?, ?, ?, ?, ?, ?)";

    // Prepare and bind
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $nama_depan, $nama_belakang, $alamat, $nomor_telepon, $email, $password);
